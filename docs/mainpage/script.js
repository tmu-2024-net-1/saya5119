// Load the Matter.js and matter-wrap plugins
var Matter = require('matter-js');
var MatterWrap = require('matter-wrap');
...
Example.ballPool = function() {
    ...
    // Load SVG paths
    var svgElements = document.querySelectorAll('svg path');
    svgElements.forEach(function(pathElement) {
        var path = pathElement.getAttribute('d');
        var vertices = Svg.pathToVertices(path, 30);
        Composite.add(world, Bodies.fromVertices(400, 200, vertices, {
            render: {
                fillStyle: '#231815'
            }
        }, true));
